...
export const MOCK_VISITS: Visit[] = [
  ...
  },
  {
    ...
    visitDate: null, // A programmed visit shouldn't have a completion date
    deadlineDate: '2024-08-30',
    scheduledDate: '2024-08-25',
    visitType: 'Capacitación de Personal',
    preventor: 'Juan Pérez',
    observations: 'Cliente solicitó mover la fecha. Originalmente para 2024-08-20.',
  },
  {
    id: 'V-005',
    clientName: 'Constructora del Sur S.A.',
  ...
  },
  {
    ...
    clientName: 'Gastronomía Porteña SRL',
    contract: 'C-GP-2024-B',
    establishment: 'Sucursal Belgrano',
    address: 'Juramento 2100, Buenos Aires',
    status: VisitStatus.Cancelada,
    visitDate: null,
    deadlineDate: '2024-09-20',
    scheduledDate: '2024-09-15',
    visitType: 'Auditoría General',
    preventor: 'Maria Garcia',
    observations: 'Cancelada por Backoffice por reestructuración de zonas.',
  },
  {
    id: 'V-012',
    clientName: 'Constructora del Sur S.A.',
    contract: 'C-SUR-2025',
    establishment: 'Depósito de Materiales',
    address: 'Ruta 205 Km 45, Cañuelas',
    status: VisitStatus.Rechazada,
    visitDate: null,
    deadlineDate: '2024-10-01',
    scheduledDate: null,
    visitType: 'Inspección de Herramientas',
    preventor: 'Juan Pérez',
    observations: 'Rechazada por el preventor por estar fuera de su área de cobertura.',
  },
];